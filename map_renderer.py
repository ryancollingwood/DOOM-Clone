...
class MapRenderer:
    ...
    def get_bounds(segments: list[tuple[vec2]]):
        ...
        # Optimization: By comparing the segment coordinates against each other first
        # (e.g., p0x < p1x), we reduce the number of conditional checks against the
        # global min/max boundaries by 50%, speeding up this tight loop.
