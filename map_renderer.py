...
class MapRenderer:
    ...
    def get_bounds(segments: list[tuple[vec2]]):
        ...
        # Optimization: Unpack vec2 attributes into local variables.
        # By comparing the segment coordinates with each other first, we reduce
        # the number of conditional checks against the global boundaries.
