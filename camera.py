...
class Camera:
    ...
    def get_forward(self) -> glm.vec3:
        # Optimization: Inline scalar math and using native C `math.hypot` avoids
        # intermediate object allocation overhead, C-extension function calls, and is faster than Python power operators.
