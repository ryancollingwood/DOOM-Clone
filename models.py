...
class WallModel:
    ...
    def get_quad_mesh(self) -> ray.Mesh:
        ...
        # Optimization: Inlining scalar math (dx, dz) and using native C `math.hypot` avoids
        # function call overhead (glm.length, glm.normalize), intermediate Python object
        # allocations (vec3), and is faster than Python power operators, yielding a significant speedup.
        dx = x1 - x0
        dz = z1 - z0
