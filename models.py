...
class WallModel:
    ...
    def get_quad_mesh(self) -> ray.Mesh:
        ...
        # Optimization: Inlining scalar math (dx, dz) and math.hypot avoids
        ...
        # Replacing inline power arithmetic with math.hypot avoids slow Python power operator opcodes, improving performance.
        dx = x1 - x0
        dz = z1 - z0
