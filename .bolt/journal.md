...
### 2024-06-26: Optimize BSP tree traversal by inlining sector tracking
...
**Impact:** `timeit` synthetic benchmarking over 1000 nodes demonstrated that this inlining dropped traversal execution time from ~0.61s to ~0.54s, representing an approximate ~11% speedup for the core traversal calculation.
