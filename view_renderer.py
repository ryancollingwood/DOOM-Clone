...
class ViewRenderer:
    ...
    def draw(self):
        ...
        # Optimization: Cache global functions and constants to local variables.
        # This replaces expensive LOAD_GLOBAL/LOAD_ATTR bytecode instructions
        # with faster LOAD_FAST operations in the inner loop.
